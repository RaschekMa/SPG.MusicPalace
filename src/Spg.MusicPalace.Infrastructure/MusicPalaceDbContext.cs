...
namespace Spg.MusicPalace.Infrastructure
{
    public class MusicPalaceDbContext : DbContext
    {
        ...
        public void AddDataToDatabaseTest()
        {
            ...
            queen.Albums[0].AddSong(new(new Guid("fb83005e-5371-4431-9cff-7720e6afd47f"), "Radio Ga Ga", queen, queen.Albums[0], false, false));
            beatles.Albums[0].AddSong(new(new Guid("90c68128-7e6d-4f11-babf-de0610663ec9"), "Here Comes The Sun", beatles, beatles.Albums[0], false, false));
            linkinPark.Albums[0].AddSong(new(new Guid("970e4d2a-e353-4de5-beb0-3ce30e99c1a2"), "Numb", linkinPark, linkinPark.Albums[0], false, false));
